...
df1 = pd.DataFrame({'Month': Laufzeit_list, 'Gesamtrueckzahlung Fix Zins': Gesamtrueckzahlung_fix, 'Gesamtrueckzahlung Variable Zins': Gesamtrueckzahlung_variable, 'Restwert Kredit': Kreditrestwert_fix})
