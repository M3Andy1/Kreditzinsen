...
with col1:
    ...
    zins_2=st.number_input('2',4.0)
    zins_4=st.number_input('4',3.5)
    zins_6=st.number_input('6',3.0)
    zins_8=st.number_input('8',2.5)
    zins_10=st.number_input('10',2.0)
    zins_12=st.number_input('12',2.0)
...
with col2:
    ...
    zins_16=st.number_input('16',3.0)
    zins_18=st.number_input('18',2.5)
    zins_20=st.number_input('20',2.0)
