...
with col1:
    ...
    zins_2=st.number_input('2',value=4.0)
    zins_4=st.number_input('4',value=3.5)
    zins_6=st.number_input('6',value=3.0)
...
with col2:
    ...
    zins_18=st.number_input('18',value=2.5)
    zins_20=st.number_input('20',value=2.0)
    zins_22=st.number_input('22',value=1.5)
